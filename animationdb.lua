...
function AnimationDB:loadImage(imagefilename,name,height,width)
	...
	imagefilename = 'images/40' .. imagefilename
...
function AnimationDB:loadAll()
	...
	AnimationDB:loadImage('player_white.png','whitePlayer',50,50)
	...
	AnimationDB:loadImage('player_blue.png','bluePlayer',50,50)
	...
	AnimationDB:loadImage('player_red.png','redPlayer',50,50)
	...
	AnimationDB:loadImage('player_green.png','greenPlayer',50,50)
	...
	AnimationDB:loadImage('imitator.png','imitator',50,50)
	...
	AnimationDB:loadImage('launcher.png','launcher',50,50)
	AnimationDB:addAni('launcherLoading','launcher',{1,2,3},{.45,.45,1e6})

	AnimationDB:loadImage('explosion.png','explosion',50,50)
	AnimationDB:addAni('explosionExplode','explosion',{1,2,3,4,5,6,6},{.05,.05,.1,.1,.1,.1,1e6})

	AnimationDB:loadImage('tiles6_gapped.png','tiles',50,50)
	...
	AnimationDB:loadImage('bandana.png','bandana',50,50)
	...
	AnimationDB:loadImage('bouncer.png','bouncer',50,50)
	AnimationDB:addAni('bouncer','bouncer',{2,1},{0.1,1e6})

	AnimationDB:loadImage('button.png','button',50,50)
	...
	AnimationDB:loadImage('crumbleblock.png','crumbleblock',50,50)
	AnimationDB:addAni('crumbleblock','crumbleblock',{1},{1e6})
	
	AnimationDB:loadImage('glassblock.png','glassblock',50,50)
	...
	AnimationDB:loadImage('crumble.png','crumble',20,20)
	...
	AnimationDB:loadImage('butterfly.png','butterfly',20,20)
	...
	AnimationDB:loadImage('meat.png','meat',20,20)	
