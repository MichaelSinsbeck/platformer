...
function AnimationDB:loadAll()
	...
	AnimationDB:loadImage('images/runnermouth.png','runnerMouth')
	...
	AnimationDB:loadImage('images/cannon.png','cannon',50,50)
	AnimationDB:addAni('cannon','cannon',{1},{1e6})

	AnimationDB:loadImage('images/goalie.png','goalie',50,50)
	AnimationDB:addAni('goalie','goalie',{1},{1e6})

	AnimationDB:loadImage('images/launcher.png','launcher',50,50)
	AnimationDB:addAni('launcher','launcher',{1},{1e6})
	AnimationDB:loadImage('images/launcherSon.png','launcherSon',50,50)
	AnimationDB:addAni('launcherSon','launcherSon',{1},{1e6})

	AnimationDB:loadImage('images/missile.png','missile',50,50)
