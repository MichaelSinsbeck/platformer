...
function BgObject:init()
	...
	self:addToCategory( list["plants"], "stone1.lua", 9, 6 )
	self:addToCategory( list["plants"], "stone2.lua", 5, 6 )
	self:addToCategory( list["plants"], "stone3.lua", 3, 3 )
	self:addToCategory( list["plants"], "stone4.lua", 5, 5 )
	self:addToCategory( list["plants"], "stone5.lua", 7, 7 )
