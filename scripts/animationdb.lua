...
function AnimationDB:loadAnimations()
	...
	AnimationDB:addAni('evilprewalker','walker',{8},{1e6})
	AnimationDB:addAni('evilwalker','walker',{1},{1e6})
	AnimationDB:addAni('evilwalkerfoot','walker',{2},{1e6})
	AnimationDB:addAni('evilwalkerfoot2','walker',{3},{1e6})
	AnimationDB:addAni('goodprewalker','walker',{7},{1e6})
	AnimationDB:addAni('goodwalker1','walker',{4},{1e6})
	AnimationDB:addAni('goodwalker2','walker',{10},{1e6})
	AnimationDB:addAni('goodwalkerfoot','walker',{5},{1e6})
	AnimationDB:addAni('goodwalkerfoot2','walker',{6},{1e6})	
	AnimationDB:addAni('goodwalkerblink1','walker',{9,4},{0.1,1e6})
	AnimationDB:addAni('goodwalkerblink2','walker',{11,10},{0.1,1e6})
