...
function AnimationDB:loadAllImages()
	...
	AnimationDB:loadTiledImage('anchor.png','anchor',tileSize,tileSize)
	AnimationDB:loadTiledImage('follower.png','follower',tileSize,tileSize)
...
function AnimationDB:loadAnimations()
	...
	AnimationDB:addAni('followerBack','follower',{5},{1e6})
	AnimationDB:addAni('followerOpen','follower',{1,2,3,4},{0.1,0.1,0.1,1e6})
	AnimationDB:addAni('followerClose','follower',{4,3,2,1},{0.1,0.1,0.1,1e6})
	AnimationDB:addAni('followerPupil','follower',{6},{1e6})
	...
	AnimationDB:addAni('LEcOff'  ,'editorButton',{1},{1e6})
	AnimationDB:addAni('LEcHover','editorButton',{2},{1e6})
	AnimationDB:addAni('LEcOn'   ,'editorButton',{3},{1e6})
	AnimationDB:addAni('LEdOff'  ,'editorButton',{4},{1e6})
	AnimationDB:addAni('LEdHover','editorButton',{5},{1e6})
	AnimationDB:addAni('LEdOn'   ,'editorButton',{6},{1e6})
	AnimationDB:addAni('LEgOff'  ,'editorButton',{7},{1e6})
	AnimationDB:addAni('LEgHover','editorButton',{8},{1e6})
	AnimationDB:addAni('LEgOn'   ,'editorButton',{9},{1e6})
	AnimationDB:addAni('LErOff'  ,'editorButton',{10},{1e6})
	AnimationDB:addAni('LErHover','editorButton',{11},{1e6})
	AnimationDB:addAni('LErOn'   ,'editorButton',{12},{1e6})
	AnimationDB:addAni('LEyOff'  ,'editorButton',{13},{1e6})
	AnimationDB:addAni('LEyHover','editorButton',{14},{1e6})
	AnimationDB:addAni('LEyOn'   ,'editorButton',{15},{1e6})
	AnimationDB:addAni('LEoOff'  ,'editorButton',{85},{1e6})
	AnimationDB:addAni('LEoOn'   ,'editorButton',{86},{1e6})
	AnimationDB:addAni('LEoHover','editorButton',{87},{1e6})		
	AnimationDB:addAni('LEbOff'  ,'editorButton',{16},{1e6})
	AnimationDB:addAni('LEbHover','editorButton',{17},{1e6})
	AnimationDB:addAni('LEbOn'   ,'editorButton',{18},{1e6})
	AnimationDB:addAni('LEwOn'   ,'editorButton',{97},{1e6})
	AnimationDB:addAni('LEwOff'  ,'editorButton',{98},{1e6})
	AnimationDB:addAni('LEwHover','editorButton',{99},{1e6})	
	-- spikes
	AnimationDB:addAni('LE1Off'  ,'editorButton',{37},{1e6})
	AnimationDB:addAni('LE1Hover','editorButton',{38},{1e6})
	AnimationDB:addAni('LE1On'   ,'editorButton',{39},{1e6})
	AnimationDB:addAni('LE2Off'  ,'editorButton',{40},{1e6})
	AnimationDB:addAni('LE2Hover','editorButton',{41},{1e6})
	AnimationDB:addAni('LE2On'   ,'editorButton',{42},{1e6})
	AnimationDB:addAni('LE3Off'  ,'editorButton',{91},{1e6})
	AnimationDB:addAni('LE3Hover','editorButton',{92},{1e6})
	AnimationDB:addAni('LE3On'   ,'editorButton',{93},{1e6})
	AnimationDB:addAni('LE4Off'  ,'editorButton',{94},{1e6})
	AnimationDB:addAni('LE4Hover','editorButton',{95},{1e6})
	AnimationDB:addAni('LE4On'   ,'editorButton',{96},{1e6})
	AnimationDB:addAni('LE5On'   ,'editorButton',{88},{1e6})
	AnimationDB:addAni('LE5Off'  ,'editorButton',{89},{1e6})
	AnimationDB:addAni('LE5Hover','editorButton',{90},{1e6})	
