...
function AnimationDB:loadAll()
	...
	AnimationDB:addAni('LEEraserOff'  ,'editorButton',{22},{1e6})
	AnimationDB:addAni('LEEraserHover','editorButton',{23},{1e6})
	AnimationDB:addAni('LEEraserOn'   ,'editorButton',{24},{1e6})
