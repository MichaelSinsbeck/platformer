...
function AnimationDB:loadAllImages()
	...
	AnimationDB:loadTiledImage('speechbubble.png','speechbubble')
...
function AnimationDB:loadAnimations()
	...
	AnimationDB:addAni('yellowRun','yellowPlayer',{3,1,2,1},{.08,.04,.08,.04})
	AnimationDB:addAni('yellowWalk','yellowPlayer',{22,21,23,21},{.08,.04,.08,.04})
	AnimationDB:addAni('yellowJump','yellowPlayer',{6},{1e6})
	AnimationDB:addAni('yellowFall','yellowPlayer',{7,8},{.1,1e6})
	AnimationDB:addAni('yellowWall','yellowPlayer',{11,12,13},{0.4,0.075,1e6})
	AnimationDB:addAni('yellowSliding','yellowPlayer',{4},{1e6})
	AnimationDB:addAni('yellowStand','yellowPlayer',{21},{1e6})
	AnimationDB:addAni('yellowLineSlide','yellowPlayer',{9},{1e6})
	AnimationDB:addAni('yellowLineMove','yellowPlayer',{16,17,18,17},{0.08,0.04,0.08,0.04})
	AnimationDB:addAni('yellowLineHang','yellowPlayer',{19},{1e6})
	AnimationDB:addAni('yellowDead','yellowPlayer',{24},{1e6})
	--AnimationDB:addAni('whiteDoubleJump','whitePlayer',{5,10,15,20,25,7},{.08,.08,.15,.08,.08,1e6})
	AnimationDB:addAni('yellowDoubleJump','yellowPlayer',{8,7,6},{.1,.1,1e6})
