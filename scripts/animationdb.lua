...
function AnimationDB:loadAnimations()
	...
	AnimationDB:addAni('LESpikes3On'    ,'editorButton',{88},{1e6})
	AnimationDB:addAni('LESpikes3Off'   ,'editorButton',{89},{1e6})
	AnimationDB:addAni('LESpikes3OHover','editorButton',{90},{1e6})	
